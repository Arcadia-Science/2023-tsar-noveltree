...
We are currently deploying all of our Nextflow workflows, including NovelTree (LINK), through Nextflow Tower using AWS Batch. When we ran our analyses on Nextflow Tower for the pub associated with this repository, we specified a handful of additional configurations.  
