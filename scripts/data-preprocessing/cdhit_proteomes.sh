...
do
    ...
    cd-hit -T 16 -l 50 -i ./isoform_reduced/$p -o ./final_proteins/${spp}.fasta
done

# and the lingering transcriptomes for which we couldn't remove redundant isoforms
while read spp
do
    cd-hit -T 16 -l 50 -i ./unfilt_proteins/$spp.fasta -o ./final_proteins/${spp}.fasta
...
while read spp
do
    cd-hit -T 16 -c 0.95 -l 50 -i ./unfilt_proteins/$spp.fasta -o ./final_proteins/${spp}.fasta
