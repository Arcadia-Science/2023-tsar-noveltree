---
title: "PhylOrthology Results: TSAR Eukaryotes"
...
# Application of `PhylOrthology` to TSAR Eukaryotes. 
Here, we summarize the multitude of results produced by the `PhylOrthology` workflow. Because results come from numerous distinct software, we have provided a complementary script containing helper functions to summarize these outputs. 
...
suppressPackageStartupMessages(
  suppressWarnings(source('./phylorthology-summary-functions.R')))
source('./arcadia-color-gradients.R')

# Specify where the workflow outputs are stored
result_directory <- '../../../../Projects/2023-tsar-phylorthology/results-tsar-eukaryotes-06062023/'
...
```{r BUSCO, fig.height = 10, fig.width = 13}
